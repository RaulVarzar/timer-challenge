...
export default function TimerChallenge({title, targetTime, submitResult, nameIsEmpty}){
    ...
    const inactive = 'w-fit xl:px-10  md:w-auto group pt-4 md:pt-8 pb-2 px-4 text-center overflow-hidden  rounded-lg cursor-pointer group elevation-7 hover:elevation-0 bg-primary bg-opacity-80 hover:bg-opacity-100'
    const active = 'content-center w-fit xl:px-10 md:w-auto bg-warning group pt-4 md:pt-8 pb-2 px-4 text-center overflow-hidden rounded-lg cursor-pointer group elevation-7 '
    ...
    return (
        <>
            ...
            >
                ...
                <p className={"mb-2 text-xl text-stone-300 transition duration-300 md:mb-6 group-hover:text-white " + (timerActive? " opacity-0" :'')}>
